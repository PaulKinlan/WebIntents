...
tools/chrome/extensions/subscribe/manifest.json: tools/chrome/extensions/subscribe-manifest.json
	cat ./tools/chrome/extensions/subscribe-manifest.json | sed 's|"version":.*|"version": "$(NOW)",|' > ./tools/chrome/extensions/subscribe/manifest.json 

tools/chrome/extensions/subscribe.crx: tools/chrome/extensions/share/manifest.json tools/chrome/extensions/subscribe/background.js
	./packcrx.sh tools/chrome/extensions/subscribe tools/chrome/key.pem
